  ...
  <div class="payFailed-container">
    ...
    <div class="flex1 over-hidden">
      ...
      >
        ...
        <el-table-column label="经办时间" align="center" prop="createTime" />
        <el-table-column label="审核时间" align="center" prop="auditTime" />
        <el-table-column label="支付备注" align="center" prop="remark" />
        <el-table-column label="失败原因" align="center" prop="failingReason" />
      </el-table>
    </div>
    <el-pagination
...
export default {
  ...
  methods: {
    ...
    exportFun() {
      ...
      exportOpenRecord(query).then(res => {
        downloadWord(res, '支付失败列表.xlsx')
      })
    },
    // 获得合计行
    getSummaries(param) {
