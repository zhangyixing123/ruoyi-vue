    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          >
            <el-select
              v-model.trim="activeData.justify"
              placeholder="请选择水平排列"
              :style="{ width: '100%' }"
            >
              <el-option
          ...
          <el-form-item v-if="activeData.labelWidth !== undefined" label="标签宽度">
            <el-input
              v-model.trim.number="activeData.labelWidth"
              type="number"
              placeholder="请输入标签宽度"
            />
          </el-form-item>
          ...
          >
            <el-input
              v-model.trim="activeData.style.width"
              placeholder="请输入组件宽度"
              clearable
            />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.autosize !== undefined" label="最小行数">
            <el-input-number
              v-model.trim="activeData.autosize.minRows"
              :min="1"
              placeholder="最小行数"
            />
          </el-form-item>
          <el-form-item v-if="activeData.autosize !== undefined" label="最大行数">
            <el-input-number
              v-model.trim="activeData.autosize.maxRows"
              :min="1"
              placeholder="最大行数"
            />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.fileSize !== undefined" label="文件大小">
            <el-input v-model.trim.number="activeData.fileSize" placeholder="请输入文件大小">
              <el-select
                slot="append"
                v-model.trim="activeData.sizeUnit"
                :style="{ width: '66px' }"
              >
          ...
          <el-form-item v-if="activeData['list-type'] !== undefined" label="列表类型">
            <el-radio-group v-model.trim="activeData['list-type']" size="small">
          ...
          <el-form-item v-if="activeData['picker-options'] !== undefined" label="时间段">
            <el-input
              v-model.trim="activeData['picker-options'].selectableRange"
              placeholder="请输入时间段"
            />
          </el-form-item>
          ...
          <template v-if="['el-cascader'].indexOf(activeData.tag) > -1">
            ...
            <el-form-item label="数据类型">
              <el-radio-group v-model.trim="activeData.dataType" size="small">
