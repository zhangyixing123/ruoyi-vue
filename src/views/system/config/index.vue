<template>
  <div class="app-container flex1 flex-col over-hidden">
    ...
    >
      ...
      <el-form-item label="参数健名" prop="configKey">
        <el-input
    ...
    <div class="flex1 over-hidden">
      ...
      >
        ...
        <el-table-column
          ...
          :show-overflow-tooltip="true"
        />
        <el-table-column label="参数健名" align="center" prop="configValue" />
        <el-table-column
          label="系统内置"
          align="center"
          prop="configType"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="参数健名" prop="configKey">
          <el-input v-model="form.configKey" placeholder="请输入参数健名" />
        </el-form-item>
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm(`是否确认导出所有参数数据项?`, `警告`, {
        ...
        .then(response => {
          downloadWord(response, '参数设置.xlsx')
        })
    },
    /** 清理缓存按钮操作 */
    handleClearCache() {
