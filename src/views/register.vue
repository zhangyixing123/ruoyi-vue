    ...
    >
      ...
      <el-row>
        <el-form-item prop="comfirmPassword" label="确认密码">
          <el-input
            v-model.trim="registerForm.comfirmPassword"
            type="password"
            auto-complete="off"
            placeholder="确认密码"
          >
      ...
      <el-row style="text-align:center;">
        <el-checkbox
          ...
          <el-button type="text" @click="getFileShow('REGISTER', 'REGISTER_PROTOCOL')"
            >《用户注册协议》</el-button
          >
          <el-button type="text" @click="getFileShow('REGISTER', 'PRIVACY_POLICY')"
            >《隐私政策》</el-button
          >
        </el-checkbox>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    register() {
      ...
      params.comfirmPassword = Encrypt(params.comfirmPassword)
